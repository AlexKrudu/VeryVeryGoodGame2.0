...
class LabelMenu:
    def __init__(self, rect, text):
        ...
        self.font = pygame.font.Font("10930.ttf", self.Rect.height - 4)
...
gui.add_element(ButtonMenu((800, 380,170,50), "продолжить игру"))
gui.add_element(ButtonMenu((800, 450,170,50), "выйти"))
